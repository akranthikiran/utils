...
public class DeleteChildrenQuery extends Query implements IChildQuery
{
	...
	public DeleteChildrenQuery(EntityDetails childEntityDetails, EntityDetails parentEntityDetails)
	{
